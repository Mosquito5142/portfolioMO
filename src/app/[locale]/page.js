  ...
  return (
    <main className="flex min-h-screen flex-col bg-[#121212]">
      ...
      <div className="container mt-24 mx-auto px-12 py-4">
        ...
        <ProjectsSection myprojects={Myprojects('myprojects')} all={Myprojects('all')} web={Myprojects('web')} mobile={Myprojects('mobile')} web1={Myprojects('web1')} web1discription={Myprojects('web1discription')} web2={Myprojects('web2')} web2discription={Myprojects('web2discription')} web3={Myprojects('web3')} web3discription={Myprojects('web3discription')} />
        <Certificate />
      </div>
      <Footer />
    </main>
