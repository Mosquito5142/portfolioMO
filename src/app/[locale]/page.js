    ...
    <main className="flex min-h-screen flex-col bg-[#121212]">
      ...
      <div className="container mt-24 mx-auto px-12 py-4">
        ...
        <AboutSection
          ...
          education1={About('education1')}
          education2={About('education2')}
          education3={About('education3')}
          education4={About('education4')}
          education5={About('education5')}
        />
        <ProjectsSection
          myprojects={Myprojects('myprojects')}
          all={Myprojects('all')}
          web={Myprojects('web')}
          mobile={Myprojects('mobile')}
          web1={Myprojects('web1')}
          web1discription={Myprojects('web1discription')}
          web2={Myprojects('web2')}
      ...
      <Footer connect={FooterTranslation('connect')} />
    </main>
  );
}
